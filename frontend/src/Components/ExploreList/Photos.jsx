...
const Photos = () => {
  return (
    <section>
        <div className="mx-auto w-full flex flex-col items-center justify-end h-[700px] md:h-[800px] lg:h-[900px] xl:h-[1000px]"
        style={{
