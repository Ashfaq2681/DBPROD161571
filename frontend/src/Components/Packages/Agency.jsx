      ...
      <div className="px-8 md:px-16 lg:px-20 xl:px-32 py-5 mt-10 lg:mt-0 bg-[#F5F5F5]">
        <div className="flex flex-col items-center justify-center py-10 lg:py-40 px-7 ">
          ...
          <div className="flex flex-col lg:flex-row flex-wrap justify-center gap-14 text-[#727272] mt-24">
            <div className="p-10 bg-white rounded-xl shadow-lg hover:shadow-2xl duration-300 ease-in-out">
            ...
            <div className="p-10 bg-[#4A16D8] rounded-xl shadow-lg hover:shadow-2xl duration-300 ease-in-out text-gray-300">
