    ...
    <section className="text-[#727272] mt-10 lg:mt-0">
      <div className="px-8 md:px-16 lg:px-20 xl:px-32 py-5 md:py-16 lg:py-40 text-center leading-tight">
        ...
        <span className="text-[70px] font-bold my-5 lg:my-10">
          ...
          <p className="text-[#3b82f6]">Enterprise plans</p>
        </span>
        ...
        <div className="flex flex-col items-center justify-center py-40 px-7 ">
          ...
          <div className="flex flex-col lg:flex-row flex-wrap justify-center gap-14 text-[#727272] mt-24">
            <div id="free" className="p-10 bg-white rounded-md shadow-lg hover:shadow-2xl duration-300 ease-in-out">
              ...
              <button onClick={() => checkSubscription(EnterpriseFree)} className="px-8 rounded-full bg-[#3b82f6] text-white border border-[#3b82f6] mx-auto font-bold py-2 w-full mb-3">
                Buy Premium Images
              </button>
            </div>
            <div id="pro" className="p-10 bg-[#3b82f6] rounded-md shadow-lg hover:shadow-2xl duration-300 ease-in-out text-gray-300">
              ...
              <button onClick={() => checkSubscription(EnterprisePro)} className="px-8 rounded-full bg-white text-[#3b82f6] border border-white mx-auto font-bold py-2 w-full mb-3">
                Buy Premium Images
              </button>
            </div>
            <div id="full" className="p-10 bg-white rounded-md shadow-lg hover:shadow-2xl duration-300 ease-in-out">
              ...
              <button onClick={() => checkSubscription(FullEnterprise)} className="px-8 rounded-full bg-[#3b82f6] text-white border border-[#3b82f6] mx-auto font-bold py-2 w-full mb-3">
                Buy Premium Images
              </button>
            </div>
          </div>
