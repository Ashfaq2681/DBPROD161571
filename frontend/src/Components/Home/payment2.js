...
import sun from "./assets/Ellipse.png";
export default function Payments2() {
  return (
    <div>
      <Header />
      <div>
        <div className=" md:flex lg:flex xl:flex my-12">
            ...
            <div className="flex flex-col items-center p-3 ">
              <span className="my-12 p-3 ml-14">
                <h1 className="text-gray-500 font-bold text-3xl">
                  Creating Together, Inspiring Beyond
                </h1>
                <p className="text-gray-500 text-md mt-5">
                  Collaboration sparks innovation and encourages each member to
                  push beyond their individual limits, fostering an environment
                  where inspiration is shared and multiplied.{" "}
                </p>
              </span>
            </div>
            <span className="flex justify-start ml-20">
              <img src={sun} alt="sun" height={100} width={100} />
            </span>
          </div>
            ...
            <div className="w-full">
              ...
              <div className="flex space-x-3 ">
                <input
                  ...
                  id="first-name"
                  autocomplete="given-name"
                  class="block w-full sm:w-4/12 rounded-md bg-gray-200 px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                />
                <input
                  type="text"
