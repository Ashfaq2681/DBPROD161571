...
const Login = () => {
  ...
  return (
    <section className="bg-[#F9FAFB] h-lvh flex flex-row justify-center pt-20 mt-5 lg:mt-0">
      <div className="flex flex-col justify-center items-center text-center rounded-xl md:rounded-r-none border border-[#c7c7c7] md:border-r-0 p-12 lg:px-32 m-4 md:m-0 md:mr-0 shadow-2xl bg-white text-[#727272] h-[624px] lg:h-[664px] max-w-[400px] lg:max-w-full">
