...
function PaymentComponent({ price }) {
    ...
    return (
        <div className="mx-auto p-8 rounded-lg shadow-md bg-white text-gray-600 max-w-screen-xl">
            ...
            <div className="flex flex-col items-start gap-3 mb-4">
                <span className="text-lg font-semibold">Premium Icons</span>
            ...
            <p className="text-[16px] font-light mb-2">{price.annual}$ + Taxes</p>
            <p className="text-[16px] font-light mb-2">
                This plan will renew annually. You will be charged now and again at each renewal.
            </p>
